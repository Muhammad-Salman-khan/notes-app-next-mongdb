    ...
    <>
      <div className="max-w-2xl mx-auto px-3 sm:px-4 py-6 sm:py-8">
        <Link href={`/save-notes/`}>
          <Button className="text-sm mb-6 sm:mb-8 font-extrabold flex items-center gap-1 transition-colors">
            <StepBack /> back to notes
          </Button>
        </Link>

        <div className="border rounded-xl p-4 sm:p-6 md:p-8 bg-background">
          <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-3 sm:gap-4 mb-6">
            <h1 className="text-xl sm:text-2xl font-medium warp-break-words">
              {data.title}
            </h1>
          ...
          <div className="border-t pt-4 flex flex-col sm:flex-row sm:justify-between gap-3 sm:gap-0">
            <div>
